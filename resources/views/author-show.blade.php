                    ...
                    <ul class="list-unstyled list-inline">
                        @if($facebook = $user->social->facebook)
                            <li class="list-inline-item">
                                <a href="{{ $facebook }}" title="Facebook"><x-icon src="facebook.svg"/></a>
                            </li>
                        @endif

                        @if($twitter = $user->social->twitter)
                            <li class="list-inline-item">
                                <a href="{{ $twitter }}" title="Twitter"><x-icon src="twitter.svg"/></a>
                            </li>
                        @endif

                        @if($instagram = $user->social->instagram)
                            <li class="list-inline-item">
                                <a href="{{ $instagram }}" title="Twitter"><x-icon src="instagram.svg"/></a>
                            </li>
                        @endif

                        @if($website = $user->social->website)
                            <li class="list-inline-item">
                                <a href="{{ $website }}" title="Twitter"><x-icon src="website.svg"/></a>
                            </li>
                        @endif
                    </ul>
                </div>
