                ...
                <div class="col-md-6">
                    <fieldset>
                        ...
                        <div class="mb-3">
                            ...
                            {{ old('user.about_me', $user->about_me  )}}
                            </textarea>
                        </div>
                    </fieldset>
                    <fieldset class="mt-3">
                ...
                <div class="col-md-6">
                    <fieldset>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" name="user[cover_image]" id="cover_image" class="form-control" value="{{ old('user.cover_image', $user->cover_image) }}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox"
                                       ...
                                       @if(old('options.email_notification.new_comment', json_decode($user->setting->email_notification, true)['new_comment'] ?? null) == 1) checked @endif
                                >
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox"
                                       ...
                                       @if(old('options.email_notification.new_image', json_decode($user->setting->email_notification, true)['new_image'] ?? null) == 1) checked @endif
                                >
