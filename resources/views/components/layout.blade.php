                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    @guest
                        ...
                        @if (Route::has('register'))
                            <li class="nav-item">
                                <a class="btn btn-danger ms-2" href="{{ route('register') }}">{{ __('Register') }}</a>
                            </li>
                        @endif
                    @else
                        <li class="nav-item"><a href="{{ route('images.index') }}" class="nav-link {{ request()->is('account/images*') ? 'active' : '' }} active">Images</a></li>
